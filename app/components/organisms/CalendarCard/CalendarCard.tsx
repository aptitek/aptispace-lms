...
function resolveChipSize(size: CalendarCardSize): "small" | "medium" {
  return size === "large" ? "medium" : "small";
}

function useCalendarCardCalculations(
...
export const CalendarCard = forwardRef<HTMLDivElement, CalendarCardProps>(
  function CalendarCard(props, ref) {
    ...
    const { targetDayjs, monthYear, dayNumber, weekday, relativeInfo } =
      useCalendarCardCalculations(date, normLocale, relativeOptions);
