...
import AccessCodeChip from "./MapCardAccessChip";
...
export interface MapCardLabels {
  campus: string;
  building: string;
  room: string;
  floor: string;
...
export interface MapCardItineraryProps {
  mode: MapCardMode;
  size: MapCardSize;
...
const PAD_MAP: Record<MapCardSize, string> = {
  small: "52px",
  medium: "58px",
  large: "64px",
};

const FAB_ICON_SIZE_MAP: Record<MapCardSize, string> = {
  small: "1.15rem",
  medium: "1.3rem",
  large: "1.45rem",
};

function getRightPad(showDirectionsButton: boolean, size: MapCardSize): string {
...
export function MapCardItinerary({
  mode,
  size,
  orientation,
  campus,
