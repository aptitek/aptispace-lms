...
import type { EmailFieldSize, EmailFieldVariant } from "./EmailField.types";
import { SOLARIZED_BASE } from "../../../tokens/theme";

interface RootProps {
  fullWidth?: boolean;
  isDisabled?: boolean;
  sizePreset?: EmailFieldSize;
  variantStyle?: EmailFieldVariant;
}
...
function getFieldMetrics(sizePreset: EmailFieldSize = "medium"): Metrics {
  switch (sizePreset) {
    case "small":
      return {
        shape: "6px",
