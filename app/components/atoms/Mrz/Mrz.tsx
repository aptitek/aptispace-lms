...
import type { MrzProps, MrzValidationResult, Td1MrzData } from "./Mrz.types";
import { generateTd1Mrz, validateTd1Mrz } from "~/utils/icao9303";
import { MrzContainer, MrzPre, StatusPill } from "./Mrz.styles";
...
function ValidationBadge({ validation }: ValidationBadgeProps) {
  ...
  let tooltip = invalidLabel;
  if (validation.isValid) {
    tooltip = validLabel;
  } else if (validation.errors.length > 0) {
    tooltip = validation.errors.join("; ");
  }
