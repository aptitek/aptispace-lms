...
import type { TextFieldSize, TextFieldVariant } from "./TextField.types";
import { SOLARIZED_BASE } from "../../../tokens/theme";

interface RootProps {
  fullWidth?: boolean;
  isDisabled?: boolean;
  sizePreset?: TextFieldSize;
  variantStyle?: TextFieldVariant;
}
...
export function getFieldMetrics(sizePreset: TextFieldSize = "medium"): Metrics {
  switch (sizePreset) {
    case "small":
      return {
        shape: "6px",
...
export function buildFieldTokens(theme: Theme, m: Metrics) {
  return {
    width: "100%",
