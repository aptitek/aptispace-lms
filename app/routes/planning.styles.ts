...
export { RootContainer } from "~/components/templates/PlanningLayout";
...
export function createSvgDataUri(path: string, fill = "currentColor"): string {
...
export const CalendarFrame = styled(Box)(({ theme }) => ({
  ...
  "& .MuiEventCalendar-timeGridEvent::before": {
    ...
    ...theme.applyStyles("dark", {
      boxShadow: `1px 0 0 0 ${alpha(theme.palette.common.black, 0.35)} !important`,
    }),
  },
  ...
  ...theme.applyStyles("dark", {
    ...
    "& .event-remote, & [data-palette='blue']": {
      ...
      "--event-surface-selected-hover": alpha(theme.palette.primary.main, 0.48),
    ...
    "& .event-in-person, & [data-palette='green']": {
      ...
      "--event-surface-selected-hover": alpha(theme.palette.success.main, 0.48),
