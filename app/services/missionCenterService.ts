...
export async function getSystemMetrics(
  ...
  try {
    const [
      ...
      queryTableCount(db, groups),
      queryTableCount(db, groupMembers),
      queryTableCount(db, modules),
      queryTableCount(db, moduleActivities),
      queryTableCount(db, activityTransitions),
      queryTableCount(db, mapPositions),
      queryTableCount(db, activityVotes),
      queryTableCount(db, fights),
      queryTableCount(db, fightPhases),
      queryTableCount(db, studentDecks),
    ...
    const tableInventory: TableRowMetric[] = [
      ...
      { tableName: "groups", rowCount: totalGroups },
      { tableName: "group_members", rowCount: totalGroupMembers },
      { tableName: "modules", rowCount: totalModules },
      { tableName: "module_activities", rowCount: totalActivities },
      { tableName: "activity_transitions", rowCount: totalTransitions },
      { tableName: "map_positions", rowCount: totalMapPositions },
      { tableName: "activity_votes", rowCount: totalVotes },
      { tableName: "fights", rowCount: totalFights },
      { tableName: "fight_phases", rowCount: totalFightPhases },
      { tableName: "student_decks", rowCount: totalDecks },
