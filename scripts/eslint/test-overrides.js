export function createVitestConfig(vitestPlugin) {
  return {
    files: [
      "**/*.test.{ts,tsx,js,jsx}",
      "**/*.spec.{ts,tsx,js,jsx}",
...
export function createStorybookConfig(storybookPlugin) {
  return {
    files: [
...
export function createCssConfigs(cssPlugin, cssTokensPlugin) {
  return [
    {
      files: ["**/*.css"],
      language: "css/css",
