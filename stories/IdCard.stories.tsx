...
import { IdCard } from "../app/components/molecules/IdCard";
...
const meta: Meta<typeof IdCard> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "ISO/IEC 7810 ID-1 standard physical credential molecule ($85.60\\text{ mm} \\times 53.98\\text{ mm}$) featuring 3D flip physics, procedural Guilloche security rosettes, dynamic holographic foil reflection, embedded microchip/NFC electronics, and transparent acrylic options.",
      },
    },
  },
  argTypes: {
  ...
  render: (args) => (
    ...
    >
      ...
      >
        ...
        <IdCard {...args} size="md" electronicsFinish="gold" />
      </Box>
      <Box
        sx={{
          display: "flex",
      ...
      >
        ...
        <IdCard {...args} size="md" electronicsFinish="silver" />
      </Box>
      <Box
        sx={{
          display: "flex",
      ...
      >
        ...
        <IdCard {...args} size="md" electronicsFinish="cyan-laser" />
      </Box>
      <Box
        sx={{
          display: "flex",
      ...
      >
        ...
        <IdCard {...args} size="md" electronicsFinish="copper" />
      </Box>
    </Box>
  ),
};
  ...
  render: (args) => (
    ...
    >
      ...
      >
        ...
        <IdCard {...args} size="md" guillocheVariant="holo-spectrum" />
      </Box>
      <Box
        sx={{
          display: "flex",
      ...
      >
        ...
        <IdCard {...args} size="md" guillocheVariant="cyber-cyan" />
      </Box>
      <Box
        sx={{
          display: "flex",
      ...
      >
        ...
        <IdCard {...args} size="md" guillocheVariant="solarized-gold" />
      </Box>
      <Box
        sx={{
          display: "flex",
      ...
      >
        ...
        <IdCard {...args} size="md" guillocheVariant="cosmic-crimson" />
      </Box>
    </Box>
  ),
};
