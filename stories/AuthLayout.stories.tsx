...
const meta: Meta<typeof AuthLayout> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "Full-viewport authentication template featuring dynamic Galaxy WebGL backdrop, subtle Auth Sidebar, and centered content stage.",
      },
    },
  },
  tags: ["autodocs"],
    ...
    <AuthLayout>
      ...
      >
        ...
        <Typography variant="body2" color="text.secondary">
          Full screen template with Galaxy canvas background and Auth Sidebar.
        </Typography>
      </Box>
    </AuthLayout>
  ),
