...
const meta: Meta<typeof MapCard> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "MapCard molecule displaying OpenStreetMap (OSM) locations with an authentic 3D accordion paper map unfolding animation on load, alongside step-by-step wayfinding itinerary info (Campus, Building, Floor & Room Chip e.g. 302 = (3 | 02), and door code / access instructions).",
      },
    },
  },
  argTypes: {
