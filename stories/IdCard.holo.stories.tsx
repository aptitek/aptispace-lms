...
import { toSvgDataUrl } from "../app/components/molecules/IdCard/IdCard.holo";

const meta: Meta<typeof IdCard> = {
  title: "Molecules/IdCard/HoloLayers",
  component: IdCard,
  parameters: {
    layout: "centered",
    docs: {
      description: {
        component:
          "Holographic image layers for IdCard. Allows setting any graphic image as a holographic layer where the image alpha channel (or custom mask) reflects the iridescent foil.",
      },
    },
  },
  tags: ["autodocs"],
